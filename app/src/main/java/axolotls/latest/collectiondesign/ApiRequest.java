                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Log.e("ApiRequest", "Error parsing JSON response", e);
                            if (callback != null)
                                callback.Responce(response.toString(), "Error parsing JSON response", e);
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                // Add more detailed error handling/logging
                error.printStackTrace();
                Log.e("ApiRequest", "Volley error: " + error.toString(), error);
